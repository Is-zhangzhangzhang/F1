...
import cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Teacher;
 ...
 * 
 * @see cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Teacher
...
public class TeacherDAO extends BaseHibernateDAO {
	...
	public Teacher findById(java.lang.String id) {
		...
		try {
			Teacher instance = (Teacher) getSession().get("cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Teacher", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = getSession().createCriteria("cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Teacher")
