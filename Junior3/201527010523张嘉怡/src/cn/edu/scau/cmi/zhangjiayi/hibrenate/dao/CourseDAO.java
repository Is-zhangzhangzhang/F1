...
import cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Course;
 ...
 * 
 * @see cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Course
...
public class CourseDAO extends BaseHibernateDAO {
	...
	public Course findById(java.lang.String id) {
		...
		try {
			Course instance = (Course) getSession().get("cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Course", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Course instance) {
		...
		try {
			List results = getSession().createCriteria("cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Course")
