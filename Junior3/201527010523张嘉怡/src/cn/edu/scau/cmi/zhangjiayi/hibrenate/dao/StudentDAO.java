 ...
 * 
 * @see cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Student
...
public class StudentDAO extends BaseHibernateDAO {
	...
	public Student findById(java.lang.String id) {
		...
		try {
			Student instance = (Student) getSession().get("cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Student", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Student instance) {
		...
		try {
			List results = getSession().createCriteria("cn.edu.scau.cmi.zhangjiayi.hibrenate.domain.Student")
